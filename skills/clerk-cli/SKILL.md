...
1. Set the absolute directory containing this `SKILL.md` as `CLERK_SKILL_DIR`. For example:

   ```bash
   CLERK_SKILL_DIR=~/.claude/skills/clerk-cli
   ```
...
```bash
export CLERK_SECRET_KEY=sk_test_<your-clerk-secret-key>
